...
int main(int argc, char **argv)
{
    ...
    allowedMoves.erase(std::remove(allowedMoves.begin(), allowedMoves.end(),blockedCell1), allowedMoves.end());
    std::string blockedCell2 = receiveData(ConnectSocket, 2);
    allowedMoves.erase(std::remove(allowedMoves.begin(), allowedMoves.end(),blockedCell2), allowedMoves.end());
    std::string blockedCell3 = receiveData(ConnectSocket, 2);
    allowedMoves.erase(std::remove(allowedMoves.begin(), allowedMoves.end(),blockedCell3), allowedMoves.end());
    std::string blockedCell4 = receiveData(ConnectSocket, 2);
    allowedMoves.erase(std::remove(allowedMoves.begin(), allowedMoves.end(),blockedCell4), allowedMoves.end());
    std::string blockedCell5 = receiveData(ConnectSocket, 2);
    allowedMoves.erase(std::remove(allowedMoves.begin(), allowedMoves.end(),blockedCell5), allowedMoves.end());
